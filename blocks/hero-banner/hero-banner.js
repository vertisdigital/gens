...
carouselItems.forEach((item) => {
  ...
  const firstIconLink = block.querySelector('a[href*="https://author-p144202-e1488374.adobeaemcloud.com/content/dam/genting-singapore/herobanner/material-symbols_chevron-left%20(1).svg"]');
  const secondIconLink = block.querySelector('a[href="https://author-p144202-e1488374.adobeaemcloud.com/content/dam/genting-singapore/herobanner/material-symbols_chevron-left.svg"]');

  console.log(firstIconLink)
  console.log(secondIconLink)
