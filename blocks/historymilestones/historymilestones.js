...
<path d="M20.572 24.257C20.4598 24.0759 20.4788 23.8295 20.6284 23.6701L26.7532 17.1367C26.9241 16.9544 27.201 16.9544 27.3719 17.1367C27.5427 17.3189 27.5427 17.6143 27.3719 17.7966L21.5563 24L27.3719 30.2034C27.5427 30.3857 27.5427 30.6811 27.3719 30.8633C27.201 31.0456 26.9241 31.0456 26.7532 30.8633L20.6284 24.3299L20.572 24.257Z" fill="#8D713E"/>
</svg>`;
...
<path d="M24 1C36.7025 1 47 11.2975 47 24C47 36.7025 36.7025 47 24 47C11.2975 47 1 36.7025 1 24C1 11.2975 11.2975 1 24 1Z" stroke="#8D713E" stroke-width="2"/>
<path d="M27.428 24.257C27.5402 24.0759 27.5212 23.8295 27.3716 23.6701L21.2468 17.1367C21.0759 16.9544 20.799 16.9544 20.6281 17.1367C20.4573 17.3189 20.4573 17.6143 20.6281 17.7966L26.4437 24L20.6281 30.2034C20.4573 30.3857 20.4573 30.6811 20.6281 30.8633C20.799 31.0456 21.0759 31.0456 21.2468 30.8633L27.3716 24.3299L27.428 24.257Z" fill="#8D713E"/>
</svg>`;
  ...
  function goToSlide(newIndex) {
    if (newIndex < 0) {
      newIndex = wrappers.length - 1;
    } else if (newIndex >= wrappers.length) {
      newIndex = 0;
    }
    ...
    wrappers[newIndex].classList.add('is-active');
    yearButtons[newIndex].classList.add('is-active');
