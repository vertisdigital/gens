...
class LocalDevelopment {
  ...
  async initializeBlocks() {
    ...
    // Convert NodeList to Array and use Promise.all with map
    await Promise.all(
...
// // Replace for...of loop with array methods
...
// Remove console.log or add eslint-disable comment if needed
// eslint-disable-next-line no-console
